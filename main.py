...
def gameplay():
  ...
  while True:
    ...
    gameplayBack = Button(image=None, pos=(960, 460), textInput= "BACK", font= get_font(45), baseColor= "Black", hoveringColor= "Green")
...
def video(): 
  ...
  while True:
    ...
    resRect = resText.get_rect(center=(380,360))
    screen.blit(resText, resRect)
    
    videoBack = Button(image=None, pos=(380, 460), textInput= "BACK", font= get_font(45), baseColor= "Black", hoveringColor= "Green")
    resLeft = Button(image=None, pos=(780, 360), textInput= "<-", font= get_font(55), baseColor= "Black", hoveringColor= "Green")
    resRight = Button(image=None, pos=(1080, 360), textInput= "->", font= get_font(55), baseColor= "Black", hoveringColor= "Green")
...
def exit():
  ...
  while True:
    ...
    exitNo = Button(image=None, pos=(980, 700), textInput= "No", font= get_font(45), baseColor= "White", hoveringColor= "Green")
